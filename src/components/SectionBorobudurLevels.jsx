  ...
  return (
    <div className='flex flex-col justify-center items-center'>
      <div className='py-8 pt-16'>
        <h1 className='text-[40px] md:text-[55px] lg:text-[60px] title-color font-bold text-center '>THE BOROBUDUR LEVEL</h1>
      </div>
      <div className='p-8 lg:p-16 flex gap-16 flex-col'>
        <div>
          <div className='flex lg:flex-row flex-col gap-4 w-full justify-center'>
            <img src={khamadatu} className='rounded-lg' />
            <div className='flex gap-4 flex-col px-0 lg:mt-0 mt-8 lg:px-16 justify-center'>
              <h1 className='text-4xl lg:text-6xl title-color font-bold'>Kamadhatu</h1>
        ...
        <div>
          <div className='flex lg:flex-row flex-col w-full'>
            <div className='flex lg:order-1 order-2  gap-4 flex-col px-0 lg:mt-0 mt-8 lg:px-16  justify-center'>
            ...
            <img src={rupadhatu} className='rounded-lg flex lg:order-2 order-1' />
          </div>
        </div>
        <div>
          <div className='flex lg:flex-row flex-col w-full'>
            ...
            <div className='flex gap-4 flex-col px-0 lg:mt-0 mt-8 lg:px-16  justify-center'>
              <h1 className='text-5xl lg:text-6xl  title-color font-bold'>Arupadhatu</h1>
