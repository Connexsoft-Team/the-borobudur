...
function Footer() {
    ...
    return (
        <footer>
            <div className="footer-map w-screen">
                <iframe
            ...
            <div className="footer-top flex flex-nowrap relative overflow-hidden footer-label  gap-8 bg-[#9B3221] text-white font-bold text-4xl py-8 max-w-screen w-screen">
                    ...
                    <div className="wrapper-top py-16 flex lg:flex-row flex-col justify-between">
                        ...
                        <div className="topright text-[#E4E1D4] flex flex-col lg:mt-0 mt-4 lg:gap-3 mb-16">
                            <div className="home flex gap-6">
                                ...
                                <p className='opacity-70'>Magelang, Indonesia</p>
                            </div>
                            <div className="teams flex gap-6">
                                <p className='font-semibold'>Coordinate</p>
                                <p className='opacity-70'>-7.607355, 110.203804</p>
                            </div>
                            <div className="socialmedia flex items-center gap-2 justify-start lg:mt-0 mt-4">
                                <a href='https://www.instagram.com/borobudurpark' target='_blank' className="instagram-link border-[.4px] p-[6.5px] rounded-full flex items-center justify-center">
                                ...
                                <a href='https://www.facebook.com/borobudurpark?locale=id_ID' target='_blank' className="facebook-link border-[.4px] p-[6.5px] rounded-full flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
                                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
                                    </svg>
                                </a>
                                <a href="https://www.youtube.com/c/BorobudurParkOfficial" target='_blank' className='youtube-link border-[.4px] p-[6.5px] rounded-full flex items-center justify-center'>
